    ...
    <div className="min-h-screen bg-slate-100 text-slate-900">
      <div className="mx-auto flex min-h-screen w-full max-w-7xl items-center px-4 py-8 sm:px-6 lg:px-8">
        <div className="grid w-full gap-6 lg:grid-cols-2 lg:gap-8">
          <section className="order-2 rounded-3xl border border-slate-200 bg-white p-6 shadow-sm sm:p-8 lg:order-1 lg:p-10">
            <div className="mb-6 inline-flex items-center rounded-full border border-slate-300 bg-slate-50 px-3 py-1.5 text-xs font-semibold uppercase tracking-[0.16em] text-slate-600">
              Scheduled Maintenance
            </div>

            <div className="space-y-6">
              <div className="flex items-start gap-4">
                <div className="flex h-14 w-14 flex-shrink-0 items-center justify-center rounded-2xl border border-slate-200 bg-slate-50 text-slate-700">
                ...
                <div className="min-w-0">
                  ...
                  <p className="mt-3 max-w-2xl text-sm leading-7 text-slate-600 sm:text-base lg:text-lg">
              ...
              <div className="grid gap-3 sm:grid-cols-3">
                <div className="rounded-2xl border border-slate-200 bg-slate-50 p-4">
                  ...
                  <p className="mt-2 text-base font-semibold text-slate-900">Maintenance Active</p>
                </div>

                <div className="rounded-2xl border border-slate-200 bg-slate-50 p-4">
                  <p className="text-xs font-semibold uppercase tracking-[0.14em] text-slate-500">Access</p>
                  <p className="mt-2 text-base font-semibold text-slate-900">Administrators Only</p>
                </div>

                <div className="rounded-2xl border border-slate-200 bg-slate-50 p-4">
                  <p className="text-xs font-semibold uppercase tracking-[0.14em] text-slate-500">Availability</p>
                  <p className="mt-2 text-base font-semibold text-slate-900">Service Resuming Soon</p>
                </div>
              </div>
              ...
              <div className="flex flex-col gap-3 pt-1 sm:flex-row sm:items-center">
                ...
                <p className="text-xs leading-6 text-slate-500 sm:max-w-xs sm:text-sm">
          ...
          <aside className="order-1 lg:order-2">
            <div className="h-full rounded-3xl border border-slate-200 bg-white p-6 shadow-sm sm:p-8 lg:p-10">
              <div className="flex h-full flex-col justify-between rounded-3xl border border-slate-200 bg-slate-50 p-6">
                <div className="space-y-6">
                  ...
                  <div className="grid gap-3 sm:grid-cols-2">
                    <div className="rounded-2xl border border-slate-200 bg-white p-4">
                      <p className="text-xs font-semibold uppercase tracking-[0.14em] text-slate-500">Security</p>
                      <p className="mt-2 text-sm font-semibold text-slate-900">Administrator access enabled</p>
                    </div>
                    ...
                    <div className="rounded-2xl border border-slate-200 bg-white p-4">
                      ...
                      <p className="mt-2 text-sm font-semibold text-slate-900">Temporarily restricted</p>
                    </div>
                  </div>
                  ...
                  <div className="rounded-2xl border border-dashed border-slate-300 bg-white p-4">
                    <div className="flex items-start gap-3">
                      ...
                      <div>
                        <p className="text-sm font-semibold text-slate-900">Admin portal remains available</p>
